...
section {{ background:var(--card); border:1px solid var(--line); border-radius:12px; padding:18px; margin-bottom:16px; box-shadow:var(--shadow); }}
...
function colorFor(value){{ const palette=['#315d8c','#2f6f4e','#c9802f','#b4473d','#6d4fa3','#72806e','#8f5b2d']; let hash=0; for(const ch of String(value||'')) hash=(hash*31+ch.charCodeAt(0))>>>0; return palette[hash%palette.length] }}
