...
<section id="models-lab" class="task-section" aria-labelledby="lab-heading">
  ...
  <div id="subtab-adversarial" class="subpanel" role="tabpanel">
    ...
    <h3>Contrast-set framework (formalized)</h3>
    <p style="font-size:12px;">The sandbox is formalized as a <b>contrast-set robustness evaluation</b>. Each perturbation is a minimal change to the input, and detection rate is measured before/after.</p>
    <table style="font-size:11px;">
      ...
      <tbody>
        <tr><td><b>Phrase insertion</b></td><td>Append known persuasion phrase</td><td>Depends on base text</td><td>Should increase</td><td>Preserved</td></tr>
        <tr><td><b>Word swap</b></td><td>Replace word with synonym</td><td>Depends on base text</td><td>May decrease</td><td>Preserved</td></tr>
        <tr><td><b>Negation</b></td><td>Add "no" before key phrase</td><td>Detected</td><td>Should NOT detect</td><td>Changed</td></tr>
        <tr><td><b>Reordering</b></td><td>Swap sentence order</td><td>Detected</td><td>Should still detect</td><td>Preserved</td></tr>
      </tbody>
    </table>
    <div class="disclaimer"><strong>Evaluation metrics:</strong> Detection rate before/after, semantic validity, robustness score = 1 - |after - before| / before.</div>
  </div>
