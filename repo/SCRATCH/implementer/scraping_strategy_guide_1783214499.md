...
**Current Verified Baseline (2026-07-05)**: 254 strict-valid unique records (all with raw refs; 238+ raw files verified present on disk). 
...
- Facebook Public (indexed / search-first / groups): ~29
...
- Current: 254 total (Locanto 132 platform / 126 male H; Doplim 89; FB ~29), 456 raws, PII=0 (_contains), all referenced raws mostly present, gate --phase 4 PASSED.
