...
**Current Verified Baseline (2026-07-04, after 100+ fetch attempts, 40+ searches, storm batches, subagents, merges + strict cleans)**: 183 clean real full records (88 Locanto Peru "hombre busca mujer real", 58 Doplim Peru contactos/hombre, 31 Facebook Public indexed). 321 raw .html archived. Gate --phase4 passed (PII active, no dups). No search_evidence pollution. <<1000 per site = public exhaustion (listings 90%+ inter, directs rare + high block rate).
