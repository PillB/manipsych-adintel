...
**Current Verified Baseline (2026-07-04)**: 227 strict-valid unique records (all with raw refs). 
- Locanto Peru (hombre busca mujer real): 123
- Doplim Peru (hombre busca mujer or Contactos): 72
- Facebook Public (indexed): ~28
- Other indexed public: 4
- 427 raw `.html` archives in `data/raw/ads/`
- Gate `phase_gate.py --phase 4`: **PASSED** (PII=0, no dups, no inters, raw coherence, required fields)
- Locanto male-offering perspective (tagged): ~117
